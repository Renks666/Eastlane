...
values (
  ...
  jsonb_build_object(
    ...
    'returnPolicy', 'Возврат возможен только на территории Китая и только по уважительной причине (брак, неправильный цвет/размер). После отправки товара к вам возврат невозможен.'
  ),
  true
)
