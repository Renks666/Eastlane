      ...
      <section className="mx-auto grid max-w-7xl gap-8 px-4 pb-8 pt-10 md:grid-cols-[1.15fr_1fr] md:px-8 md:pt-14">
        <div className="rounded-3xl border border-[#d8cfb7] bg-white/90 p-7 shadow-[0_18px_48px_-34px_rgba(18,39,33,0.25)]">
          <div className="max-w-xl">
            <HeroShutterText text="EASTLANE" />
          </div>
          <h1 className="mt-6 text-4xl font-semibold leading-[1.05] text-[#0f3f33] md:text-6xl">
            Интернет-магазин
            <span className="block text-[#b29152]">одежды и обуви</span>
          </h1>
          <p className="mt-4 max-w-lg text-sm text-[#5f6e65] md:text-base">
            Минималистичное бренд-пространство с акцентом на стиль, посадку и детали.
            Заказ через менеджера, без онлайн-оплаты.
          </p>
          <div className="mt-8 flex flex-wrap gap-3">
            <Link href="/catalog" className="inline-flex items-center gap-2 rounded-full bg-[#0f5a49] px-5 py-3 text-sm font-medium text-[#f2ece0] transition hover:bg-[#0b4a3c]">
              Перейти в каталог <ArrowRight className="h-4 w-4" />
            </Link>
            <Link href="/about" className="inline-flex items-center rounded-full border border-[#d8cfb7] bg-white px-5 py-3 text-sm font-medium text-[#6f634a] transition hover:bg-[#f8f4ea]">
              О бренде
            </Link>
          </div>
        </div>
        <div className="relative overflow-hidden rounded-3xl border border-[#0f3f33] bg-[#0f3f33] p-6">
          ...
          <p className="relative text-xs uppercase tracking-[0.26em] text-[#d9bd7e]">Новые поступления</p>
