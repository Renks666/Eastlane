    ...
    <section className="store-section pb-12 md:pb-16">
      <div className="relative overflow-hidden rounded-2xl border border-[color:var(--color-border-primary)] bg-[color:var(--color-bg-primary)] p-4 shadow-[0_20px_60px_-40px_rgba(15,63,51,0.28)] md:p-6">
        ...
        <div className="relative">
          <h2 className="text-2xl font-semibold leading-tight text-[color:var(--color-brand-forest-light)] sm:text-3xl md:text-4xl">
            Модуль расчета
        ...
        <div className="relative mt-5 md:mt-6">
          <article className="rounded-xl border border-[color:var(--color-brand-forest-light)]/35 bg-[linear-gradient(160deg,#091a16_0%,#0b201a_58%,#0d251f_100%)] p-3 text-white md:p-4">
        ...
        <div className="relative mt-4 overflow-hidden rounded-xl border border-cyan-300/30 bg-[linear-gradient(160deg,rgba(8,28,23,0.92)_0%,rgba(11,34,28,0.92)_100%)] p-3.5 text-cyan-50 md:p-4">
          <span
